...
void AbstractItemModel::Private::rowsAboutToBeInserted(const QModelIndex &parent, int first, int last)
{
    // nothing to do at the moment
}
...
void AbstractItemModel::Private::rowsAboutToBeRemoved(const QModelIndex &parent, int first, int last)
{
    // nothing to do at the moment
}
...
void AbstractItemModel::Private::columnsAboutToBeInserted(const QModelIndex &parent, int first, int last)
{
...
void AbstractItemModel::Private::columnsAboutToBeRemoved(const QModelIndex &parent, int first, int last)
{
    //TODO: support column selection?
}
...
void AbstractItemModel::Private::rowsAboutToBeMoved(const QModelIndex &sourceParent, int sourceStart, int sourceEnd, const QModelIndex &destinationParent, int destinationRow)
{
    // nothing to do at the moment
}

void AbstractItemModel::Private::rowsMoved(const QModelIndex &parent, int start, int end, const QModelIndex &destination, int row)
{
    emit q->itemsChanged(bb::cascades::DataModelChangeType::Init);
}

void AbstractItemModel::Private::columnsAboutToBeMoved(const QModelIndex &sourceParent, int sourceStart, int sourceEnd, const QModelIndex &destinationParent, int destinationColumn)
{
    // nothing to do at the moment
}

void AbstractItemModel::Private::columnsMoved(const QModelIndex &parent, int start, int end, const QModelIndex &destination, int column)
{
    //TODO: support column selection?
}
...
QString AbstractItemModel::itemType(const QVariantList &indexPath)
{
    ...
    return d->m_sourceModel->data(d->indexForPath(indexPath),
                                  d->m_reverseRoleNames[d->m_itemTypeRole]).toString();
}
